...
public class Server{
    ...
    //This function is used to connect the server into a particular port number
    public static ServerSocket getServer() throws IOException
    {
            ServerSocket serverSocket = new ServerSocket(3333);
            System.out.println("Server is Connected in port 3333");

            return serverSocket;
    }

    //This function is used to send file to client location
    public void SendFileToClient(ServerSocket serverSocket) throws IOException {

        System.out.println("Started Sending the file to Client");
        System.out.println("Waiting for Client to accept the Request !!");
