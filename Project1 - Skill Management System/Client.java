...
public class Client {
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            FileOutputStream fileOutputStream = new FileOutputStream("C:\\Users\\chitransh.mathur\\OneDrive - Xebia\\Documents\\JavaPrograms\\Project1 - Skill Management System\\Required Files\\" +new Random().nextInt(10000)+".csv");
